...
namespace Testing2
{
    public partial class Form2 : Form
    {
        ...
        List<Label> allNames = new List<Label>();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            var combined = allNames.Zip(allAmounts, (n, w) => new { Name = n.Text, Amount = Int32.Parse(w.Text) });
            foreach(var iterate in combined)
            {
                Console.Write(iterate.Name);
                Console.WriteLine(iterate.Amount);
            }
